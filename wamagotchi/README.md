...
│   │   └── adventure_engine.dart # ★ 탐험 틱 로직 (전투/보물/휴식/보스, Phase 3)
│   ├── models/
...
- **Phase 4 (상점·상호작용)**: 마나로 아이템 구매·장착·사용, 키워드 감지 이벤트 — `게임시스템_기획서.md` 4·7장
- 백로그: 룸 타입 확장(함정/상인/수수께끼/균열/낙서 벽), 보스 다틱 장기전·'기세' 버프, 붙여넣기 감액 등 어뷰징 방어, 개명 아이템, 기분 '신남', 스프라이트 idle 애니메이션
